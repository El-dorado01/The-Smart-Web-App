...
function createForum() {
  ...
  formData.append("forumName", document.getElementById("forumName").value);
  formData.append("forumDesc", document.getElementById("forumDesc").value);
...
function loadAForumInfo(
  ...
  for (let i = 0; i < forumInfo.moderators.length; i++) {
    ...
    for (let a = 0; a < forumMembers.length; a++) {
      const { member, memberInfo } = forumMembers[a];
